...
function decodeStream(req:http.IncomingMessage) {
    ...
    throw new Error(`unknow encodeing: ${encoding}`);
}

export function getRawBody (req:http.IncomingMessage, lenght:number) : Promise<Buffer> {
